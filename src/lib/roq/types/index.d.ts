...
export namespace Prisma {
  ...
  */
  ...
  interface payrollFieldRefs {
    ...
    readonly payment_method: FieldRef<'payroll', 'String'>;
  ...
  export type payrollWhereInput = {
    ...
    payment_date?: DateTimeFilter<'payroll'> | Date | string;
    payment_method?: StringFilter<'payroll'> | string;
  ...
  export type payrollScalarWhereWithAggregatesInput = {
    ...
    payment_date?: DateTimeWithAggregatesFilter<'payroll'> | Date | string;
    payment_method?: StringWithAggregatesFilter<'payroll'> | string;
  ...
  export type vacationWhereInput = {
    ...
    reason?: StringFilter<'vacation'> | string;
  ...
  export type vacationScalarWhereWithAggregatesInput = {
    ...
    reason?: StringWithAggregatesFilter<'vacation'> | string;
