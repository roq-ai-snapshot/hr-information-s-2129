  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Experience the new standard in human resources management with HR Information System - Streamlining employee data, vacations, and payroll in one comprehensive platform."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1559659160-10066d7433e4?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxodW1hbiUyQnJlc291cmNlc3xlbnwwfHx8fDE2OTgzMjY4NTF8MA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience the new standard in human resources management with HR Information System - Streamlining employee data, vacations, and payroll in one comprehensive platform.`}
            </Text>
            <Box
